...
export default async function getAqiData30d(stationId: string | number) {
    const res = await axiosWithRetry.post("https://enviinfo.cem.gov.vn/eip/default/call/json/get_aqi_data?date=30&aqi_type=0", {
